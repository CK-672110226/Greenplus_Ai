export const en = {
  ...
  filterAll:        'All',
  filterSell:       'Selling',
  filterRequest:    'Wanted',
  filterEvent:      'Events',
  noListings:       'No posts yet.',
  postAd:           'Post',
  cancelLabel:      'Cancel',
  postSuccess:      'Posted!',
  ...
  closed:           'Closed',
  // P2P post types
  postTypeSell:     'Selling',
  postTypeRequest:  'Wanted / Donate',
  postTypeEvent:    'Event / Activity',
  postTitleLabel:   'Title',
  postTitlePlaceholder: 'e.g. Collecting plastic bottles near CMU',
  postDescLabel:    'Details',
  postDescPlaceholder: 'Add more context, pickup instructions, event info…',
  materialsLabel:   'Materials',
  weightOptional:   'Weight (kg, optional)',
  priceOptional:    'Price (฿/kg, optional)',
  sellTypeBadge:    'Selling',
  requestTypeBadge: 'Wanted',
  ...
  shopPendingTitle:       'Awaiting admin approval',
  shopPendingDesc:        'Your shop is under review and not yet visible to sellers on the map. You will be able to receive bookings once an admin approves it.',
