...
export function DashboardPage() {
  ...
  return (
    <main className="flex flex-col items-center px-6 py-16 gap-6">
      <h1 className="font-brand text-[28px] text-[var(--ink)] m-0">{t.dashboard}</h1>
      <Card className="w-full max-w-xl flex flex-col items-center py-10 gap-2">
        <span className="font-data text-[11px] text-[var(--ink-4)] uppercase tracking-widest">M6 — Buyer Dashboard</span>
