...
export function LoginPage() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-[80vh] px-6 py-16">
        ...
        {unverified && (
          <div className="flex flex-col gap-3 border-[1.5px] border-[var(--orange)] p-4">
            ...
            <button
              ...
              className="font-data text-[12px] uppercase tracking-widest text-[var(--ink)] underline bg-transparent border-none cursor-pointer text-left p-0"
            >
