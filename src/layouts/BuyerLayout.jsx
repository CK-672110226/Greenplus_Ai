      ...
      <aside className="hidden md:flex flex-col w-[200px] min-h-screen border-r-[1.5px] border-[var(--ink)] sticky top-0 self-start h-screen">
        ...
        <div className="px-5 py-4 border-t-[1.5px] border-[var(--ink)] flex flex-col gap-2">
          <button
            ...
            className="flex items-center gap-2 font-data text-[11px] border-[1.5px] border-[var(--ink-4)] px-2 py-1 hover:border-[var(--ink)] hover:text-[var(--ink)] text-[var(--ink-3)] transition-colors bg-transparent text-left cursor-pointer"
